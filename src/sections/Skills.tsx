      ...
      <div className="max-w-6xl mx-auto w-full">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6 md:gap-8">
          {skillsData.map((skill, index) => (
            <motion.div 
              key={index}
              className="skill-item relative flex flex-col items-center justify-center p-8 rounded-2xl bg-zinc-900 border border-zinc-800 hover:border-red-500/50 group overflow-hidden cursor-default"
            ...
            >
              ...
              <div className="text-4xl md:text-5xl mb-4 text-zinc-400 group-hover:text-red-400 transition-colors duration-300 drop-shadow-[0_0_15px_rgba(239,68,68,0)] group-hover:drop-shadow-[0_0_15px_rgba(239,68,68,0.3)]">
